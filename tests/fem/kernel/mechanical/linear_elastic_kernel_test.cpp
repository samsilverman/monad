...
TEMPLATE_LIST_TEST_CASE("monad::fem::mechanical::LinearElasticKernel (2d): Test bMatrix", "[monad]", Types2d) {
    ...
    SECTION("BU=ε for unit strains") {
        ...
        for (auto point : points) {
            ...
            FieldMatrix U = FieldMatrix::Zero();
...
TEMPLATE_LIST_TEST_CASE("monad::fem::mechanical::LinearElasticKernel (3d): Test bMatrix", "[monad]", Types3d) {
    using FieldMatrix = typename LinearElasticKernel<TestType>::FieldMatrix;
...
TEMPLATE_LIST_TEST_CASE("monad::fem::mechanical::LinearElasticKernel (2d): Test lhs/rhs", "[monad]", Types2d) {
    using FieldMatrix = typename LinearElasticKernel<TestType>::FieldMatrix;
...
TEMPLATE_LIST_TEST_CASE("monad::fem::mechanical::LinearElasticKernel (3d): Test lhs", "[monad]", Types3d) {
    using FieldMatrix = typename LinearElasticKernel<TestType>::FieldMatrix;
